...
Please report any bugs or feature requests to C<bug-poe-component-css-minifier at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-CSS-Minifier>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc POE::Component::CSS::Minifier
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-CSS-Minifier>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-CSS-Minifier>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-CSS-Minifier>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-CSS-Minifier>
